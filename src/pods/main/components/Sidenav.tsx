      ...
      <div className="p-3 border-t border-zinc-800">
        <div className={`flex items-center gap-3 hover:bg-zinc-800 rounded-lg transition-all p-2 cursor-pointer group relative ${isOpen ? '' : 'justify-center'}`}>
          <div className="relative shrink-0">
            <div 
              className="size-10 select-none rounded-full bg-lienar-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-semibold text-sm"
              draggable={false}
            >
              {getUserInitials()}
            </div>
