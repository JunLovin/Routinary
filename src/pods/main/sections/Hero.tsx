...
export default function Hero() {
  ...
  <>
      ...
      >
        ...
        <div className="hero-content max-2xl:mt-12 flex flex-col gap-6 text-sm font-medium items-center justify-center">
          ...
          <div className="hero-title">
            <h1 className="font-bold text-7xl text-center text-white max-w-[20ch] tracking-wide max-xl:text-6xl max-md:text-5xl max-sm:text-4xl">Build Your Perfect Day & <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Supercharge your focus.</span></h1>
          </div>
          ...
          <div className="hero-cta flex items-center justify-center gap-6 w-full relative">
            <button className="rounded-lg text-lg h-12 relative font-medium pl-6 pr-1 cursor-pointer bg-gradient-to-r from-orange-400 to-orange-600 text-white flex gap-4 items-center">
              Create Routine
            ...
            <div className="group-avatars flex flex-row items-center relative max-lg:hidden">
              ...
              <div className="avatars-text select-none absolute -right-90 h-26 flex justify-end items-end max-w-[30ch] text-center uppercase">
